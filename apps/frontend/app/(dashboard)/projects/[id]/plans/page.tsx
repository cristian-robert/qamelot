    ...
    <div className="p-6 space-y-6">
      ...
      <Card>
        <CardContent className="flex flex-col items-center py-12 text-center">
          ...
          <h3 className="text-lg font-semibold">No test plans yet</h3>
          <p className="mt-1 max-w-sm text-sm text-muted-foreground">
            Test plans group test cases into executable runs. Create a plan to
            organize and track your testing efforts.
          </p>
        </CardContent>
      </Card>
    </div>
